package com.backend.seqaq.tools.fenci.jieba.viterbi;
...
import com.backend.seqaq.tools.fenci.jieba.CharacterUtil;
import com.backend.seqaq.tools.fenci.jieba.Pair;
import com.backend.seqaq.tools.fenci.jieba.Node;
...
public class FinalSeg {
  ...
  private void loadModel() {
    ...
    System.out.println(
        String.format(
            Locale.getDefault(),
            "model load finished, time elapsed %d ms.",
